...
<head>
    ...
    <style type="text/css" media="screen">
        body { padding:0 !important; margin:0 auto !important; display:block !important; min-width:100% !important; width:100% !important; -webkit-text-size-adjust:none }
        ...
        .l-pink a { color: #020001; }
        .l-grey a { color: #6e6e6e; }
        .l-purple a { color: #020001; }

        .gradient { background: linear-gradient(to right, #020001 0%,#020001 100%); }

        .btn-secondary { border-radius: 10px; background: linear-gradient(to right, #020001 0%,#020001 100%); }
...
<body class="body" style="padding:0 !important; margin:0 auto !important; display:block !important; min-width:100% !important; width:100% !important;  -webkit-text-size-adjust:none;">
<center>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin: 0; padding: 0; width: 100%; height: 100%; background:#ed141f1c !important;" class="gwfw">
        <tr>
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        <td class="img-center p-30 px-15" style="font-size:0pt; line-height:0pt; text-align:center; padding: 30px; padding-left: 15px; padding-right: 15px;">
                                                                            <a href="#" target="_blank"><img src="' . $env['APP_URL'] . 'assets/admin/app-assets/img/logo/logo.webp" width="180" height="60" border="0" alt="" /></a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                <!-- Logo -->
                                                                                        ...
                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="title-36 a-center pb-15" style="font-size:36px; line-height:40px; color:#282828 !important; font-family:PT Sans, Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 15px;">
                                                                                                    <strong>Invoice Sent - '.$invoice_number.'</strong>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td class="text-16 lh-26 a-center pb-25" style="font-size:16px; color:#6e6e6e !important; font-family:PT Sans, Arial, sans-serif; min-width:auto !important; line-height: 26px; text-align:center; padding-bottom: 25px;">
                                                                                                    Thank you for choosing Cosgn to fulfill your project needs. We are pleased to inform you that the services for your selected project have been completed, and we are excited to continue our partnership.
                                                                                                    We have sent you an invoice through Cosgn. Here are the details:
                                                                                                    <br>
                                                                                                    Invoice Number: '.$invoice_number.'.<br>

                                                                                                    Amount: $'.$final_total.'.<br>
                                                                                                    Due Date: '.$due_date.'.<br>
                                                                                                    Description: '.$send_message.'.<br>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td align="center">
                                                                                                    ...
                                                                                                    <table border="0" cellspacing="0" cellpadding="0" style="min-width: 200px;">
                                                                                                        <tbody><tr>
                                                                                                            <td class="btn-16 c-white l-white" style="background-color:#020001 ; font-size:16px; line-height:20px; mso-padding-alt:15px 35px; font-family:PT Sans, Arial, sans-serif; text-align:center; font-weight:bold; text-transform:uppercase; border-radius:25px; min-width:auto !important; color:#ffffff;">
                                                                                                                <a href="'.$env['APP_URL'].'invoice/view/'.$insert.'" target="_blank" class="link c-white" style="display: block; padding: 15px 35px; text-decoration:none; color:#ffffff;">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td class="text-12 lh-22 a-center c-grey- l-grey py-20" style="font-size:12px; color:#6e6e6e; font-family:PT Sans, Arial, sans-serif; min-width:auto !important; line-height: 22px; text-align:center; padding-top: 20px; padding-bottom: 20px;">
                                                    <a href="#" target="_blank" class="link c-grey" style="text-decoration:none; color:#6e6e6e;"><span class="link c-grey" style="white-space: nowrap; text-decoration:none; color:#6e6e6e;">UNSUBSCRIBE</span></a>
                                                </td>
                                            </tr>
                                        </table>											<!-- END Bottom -->
                                    </td>
